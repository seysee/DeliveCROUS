/**
 *
 * Cette page affiche un menu sous forme de liste de plats (ou articles) récupérés à partir d'une API. Elle utilise une `FlatList` pour rendre les éléments du menu, et ajuste le nombre de colonnes en fonction de la largeur de l'écran. La page est conçue pour s'adapter aux différentes tailles d'écran (responsive).
 *
