...
export default function FavorisScreen() {
    const { favoris, toggleFavori, loading } = useFavoris();  // On récupère le loading
...
const styles = StyleSheet.create({
    ...
    emptyMessage: { fontSize: 16, color: "gray", textAlign: "center", marginTop: 20 },
    ...
    price: { fontSize: 16, color: "#007bff" },
